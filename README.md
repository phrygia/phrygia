...
<i>Frontend Junior developer. currently living in Seoul, Korea.</i><br><br>
...
const phrygia = {
  ...
  code: [JS, TS, HTML5, CSS3, SCSS, DART],
  interest: ["Productivity", "Code Reusability", "Refactoring", "Testing", "Review"]
}
``` 
<br>
